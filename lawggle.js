      ...
      saveButtons.forEach((thisbutton)=>{
        thisbutton.addEventListener("click",async (event)=>{
             ...
             if(buttonIdentifier=="section1save"){
              ...
              let hourlyRate=document.getElementById("hourlyrateinput").value
         ...
         if(mongodbuser.status=="true"){
           ...
           pageinputs.forEach(input => {
            ...
            if(clientTestimonials.length>0){
              ...
              document.getElementById("clientvideotestimonialform").style.display="none"
              document.getElementById("clientvideotestimonialshow").style.display="flex"
              document.getElementById("videotestimonialswitch").style.display="flex"
              ...
              document.getElementById("clientvideotestimonialform").style.display="flex"
            ...
            if(mediaPressBriefs.length>0){
              let thecaseslider3=document.getElementById("mediapressbriefingedit")
              thecaseslider3.innerHTML=""
              document.getElementById("themediapressform").style.display="none"
              document.getElementById("mediapressbriefingedit").style.display="flex"
              document.getElementById("pressbriefsedit").style.display="flex"
              ...
              for(let pressbrief in mediaPressBriefs){
                ...
                thecaseslider3.append(presscontainer)
              }
            }
            else{
              document.getElementById("themediapressform").style.display="flex"
              document.getElementById("mediapressbriefingedit").style.display="none"
            }
            ...
            if(caseStudyWalkthroughs.length>0){
              ...
              document.getElementById("casestudyeditform").style.display="none"
              document.getElementById("casestudyeditshowcase").style.display="flex"
              ...
              for(let eachcasestudy in caseStudyWalkthroughs){
                ...
                casevideo.classList.add("videoclass")
              ...
              document.getElementById("casestudyeditform").style.display="flex"
